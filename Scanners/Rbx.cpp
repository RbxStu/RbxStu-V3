...
static __inline std::map<RbxStu::Scanners::RBX::RobloxFunction, hat::signature> SignatureMap{
    // RBX::ScriptContext functions.
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_ScriptContext_resume, hat::parse_signature(
    ...
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_ScriptContext_getDataModel,
        hat::parse_signature("48 83 EC ? 48 85 C9 74 72 48 89 7C 24 ? 48 8B 79 ? 48 85 FF 74 22").value()
    },
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_ScriptContext_validateThreadAccess,
        hat::parse_signature("48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 41 56 41 57 48 83 EC ? 48 8B DA 48 8B E9 80")
        .value()
    },
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_ScriptContext_task_spawn,
        hat::parse_signature(
    ...
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_ScriptContext_task_defer,
        hat::parse_signature(
    ...
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_ScriptContext_getGlobalState,
    ...
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_Instance_pushInstance,
        hat::parse_signature(
            "48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B FA 48 8B D9 48 83 3A 00").value()
    },
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_Instance_getTopAncestor,
        hat::parse_signature("48 8B 41 ? 48 85 C0 74 08 48 8B C8 E9 EF FF FF FF 48 8B C1 C3 CC CC").value()
    },
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_Instance_removeAllChildren,
    ...
    // RBX::BasePart
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_BasePart_getNetworkOwner,
        hat::parse_signature("48 8B 81 ? ? ? ? 8B 88 ? ? ? ? 48 8B C2 89 0A C3").value()
    },
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBX_BasePart_fireTouchSignals,
    ...
    // Misc
    {
        RbxStu::Scanners::RBX::RobloxFunction::RBXCRASH,
        hat::parse_signature(
...
void RbxStu::Scanners::RBX::Initialize() {
    ...
    for (const auto &[enumKey, address]: RbxStu::Utilities::ScanMany(SignatureMap, true)) {
        const auto name = RobloxFunctionToString(enumKey);

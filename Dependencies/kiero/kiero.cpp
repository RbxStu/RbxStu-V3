        ...
        if (_renderType >= RenderType::D3D9 && _renderType <= RenderType::D3D12) {
            ...
            if (_renderType == RenderType::D3D9) {
                ...
                if (((long(__stdcall*)(
                        ...
                        NULL, D3D_DRIVER_TYPE_HARDWARE, NULL, 0, featureLevels, 2, D3D11_SDK_VERSION, &swapChainDesc,
            ...
            if (_renderType == RenderType::OpenGL) {
                ...
                const char *const methodsNames[] = {
                    ...
                    "vkCmdSetLineWidth", "vkCmdSetDepthBias", "vkCmdSetBlendConstants", "vkCmdSetDepthBounds",
                    "vkCmdSetStencilCompareMask", "vkCmdSetStencilWriteMask", "vkCmdSetStencilReference",
                    "vkCmdBindDescriptorSets", "vkCmdBindIndexBuffer", "vkCmdBindVertexBuffers", "vkCmdDraw",
                    "vkCmdDrawIndexed",
                    ...
                    "vkCmdUpdateBuffer", "vkCmdFillBuffer", "vkCmdClearColorImage", "vkCmdClearDepthStencilImage",
                    "vkCmdClearAttachments", "vkCmdResolveImage", "vkCmdSetEvent", "vkCmdResetEvent", "vkCmdWaitEvents",
                    "vkCmdPipelineBarrier", "vkCmdBeginQuery", "vkCmdEndQuery", "vkCmdResetQueryPool",
                    "vkCmdWriteTimestamp", "vkCmdCopyQueryPoolResults", "vkCmdPushConstants", "vkCmdBeginRenderPass",
                    "vkCmdNextSubpass",
                ...
                for (int i = 0; i < size; i++) {
                    g_methodsTable[i] = reinterpret_cast<uint150_t>(::GetProcAddress(libVulkan, methodsNames[i]));
                }
...
const char *kiero::getRenderTypeAsString(RenderType::Enum renderType) {
    switch (renderType) {
    ...
    return "how did u get in my house?";
}

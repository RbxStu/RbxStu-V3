...
namespace RbxStu::Modding {
    class __declspec(dllimport, novtable) ModContext final {
        std::string_view m_modName;
        std::string_view m_modIdentifier;
        RbxStu::Modding::ModVersion m_modVersion{};

    public:
        std::shared_ptr<RbxStu::Modding::ModContext> CreateModContext(std::string_view modName,
                                                                      std::string_view modIdentifier,
